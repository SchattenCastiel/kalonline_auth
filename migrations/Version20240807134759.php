...
final class Version20240807134759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE AuthStatistics ADD id INT IDENTITY NOT NULL');
        $this->addSql('ALTER TABLE AuthStatistics ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE ExpTable ADD id INT IDENTITY NOT NULL');
        $this->addSql('ALTER TABLE ExpTable ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE GuildRank ADD id INT IDENTITY NOT NULL');
        $this->addSql('ALTER TABLE GuildRank ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE IP ADD id INT IDENTITY NOT NULL');
        ...
        $this->addSql('ALTER TABLE Log ADD id INT IDENTITY NOT NULL');
        $this->addSql('ALTER TABLE Log ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE LoginDeleted ADD pId INT IDENTITY NOT NULL');
