...
class getNelmioApiDoc_Describers_ConfigService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(['info' => ['title' => 'KalOnline Authentication Api', 'description' => 'This should be an microservice for the KalOnline auth database', 'version' => '1.0.0']]);
    }
}
