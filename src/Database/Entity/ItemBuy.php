...
use App\Database\Repository\ItemBuyRepository;
...
class ItemBuy
{
    ...
    #[ORM\Column(name: 'Discount', type: Types::SMALLINT->value, nullable: false, options: ['default' => 0])]
    private int $discount;

    #[ORM\Id]
    #[ORM\Column(name: 'BuyDate', type: Types::DATETIME_MUTABLE->value, nullable: false, options: ['default' => 'getdate()'])]
    private DateTimeInterface $buyDate;

    #[ORM\Column(name: 'Place', type: Types::BOOLEAN->value, length: 1, nullable: false, options: ['default' => 1])]
    private bool $place;

    #[ORM\Column(name: 'charDate', type: Types::STRING->value, length: 10, nullable: false, options: ['default' => 'convert(varchar(10),getdate(),126)'])]
    private string $charDate;

    #[ORM\Column(name: 'Flag', type: Types::TINYINT->value, nullable: false, options: ['default' => 1])]
    private int $flag;
    ...
    #[ORM\Column(name: 'bSuccess', type: Types::BOOLEAN->value, nullable: false, options: ['default' => 1])]
    private bool $bSuccess;

    #[ORM\Column(name: 'ErrNum', type: Types::STRING->value, length: 20, nullable: true)]
    private ?string $errNum = null;

    #[ORM\Column(name: 'Age', type: Types::TINYINT->value, nullable: false, options: ['default' => 0])]
    private int $age;

    #[ORM\Column(name: 'Price', type: Types::INTEGER->value, nullable: false, options: ['default' => 0])]
    private int $price;
